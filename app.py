...
# ── Page config ──────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="DeepTrace · AI Research Agent",
    page_icon="🔬",
    layout="wide",
...
.stTextInput > div > div > input {
    background: #1a1a22 !important;   /* darker background */
    border: 1px solid rgba(255,140,50,0.35) !important;
    border-radius: 10px !important;

    color: #ffffff !important;        /* pure white text */
    caret-color: #ff8c32 !important;  /* cursor color */
